...
export default function PortalLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 401) {
        ...
        setError('Регистрация неактивна');
      } else {
  ...
  return (
    <>
      <Head>
        <title>Вход в портал - Fiscal Monitor</title>
      </Head>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Введите токен доступа для просмотра данных мониторинга
              </p>
            </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-gray-900"
